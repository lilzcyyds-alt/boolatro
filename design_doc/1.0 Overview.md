...
graph TD
    ...
    subgraph Proof Loop
        ...
        Goal -->|No & Hands == 0| Defeat[Defeat Stage]
...
- ✅ **Proof Logic**: Formula generation, validation, and unique card ID identification.
- ✅ **Stage UI**: Select Blind, Proof Editor, and Action Panel with Discard.
- ✅ **Effect System**: Shop logic and Special Card effects implementation.
- ✅ **Polish**: Fly-in/Fly-out card animations, refined transitions, and UI layout optimization.
