...
graph TD
    ...
    subgraph Proof Loop
        ...
        Goal -->|Yes| Cashout[Cashout Stage]
        Goal -->|No & Hands == 0| Fail[Fail - Back to Start]
    end
...
- ✅ Phase 5: Flame Engine Refactor (Current Status)
- ⏳ Phase 6: Polish / Advanced Effects (Upcoming)
